                      ...
                      <div className="col-9">
                        <div className="row">
                          <div className={`col-md-12 ${styles.contentWrapper}`}>
                            ...
                            <p
                              className={`  d-block d-md-none ${styles.content}`}
                            >
                              Log your food 260% faster than other
                              <br />
                              leading apps. It&apos;s like talking or voice{" "}
                              <br /> noting your best friend on WhatsApp. <br />{" "}
                              That easy!
                            </p>
                            <p
                        ...
                        <div className="row">
                          <div className={`col-md-12 ${styles.contentWrapper}`}>
                            ...
                            >
                              ...
                              <br /> recipe with ingredient lists &<br />{" "}
                              methods. Got chicken? Search
                              <br /> &apos;chicken&apos; and we will return a
                              list
