...
const Started = () => {
  return (
    <section className={styles.start}>
      <div className="container px-xs-5">
                ...
                <div className="col-9 col-md-10">
                  <div className="row">
                    <div className={`col-md-12  ${styles.contentWrapper}`}>
                      ...
                      >
                        Download ParrotPal, complete a brief questionaire, and
                        get your personalised health targets.
                      </p>
                  ...
                  <div className="row">
                    <div className={`col-md-12 ${styles.contentWrapper}`}>
                      ...
                      >
                        ...
                        Leveraging data from various restaurants, ParrotPal
                        offers the best average to minimize errors.
                      </p>
                      <p className={`d-block d-md-none ${styles.content}`}>
